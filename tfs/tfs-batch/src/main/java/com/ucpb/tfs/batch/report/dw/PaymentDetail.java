...
import com.ucpb.tfs.batch.report.dw.PaymentStatus;
...
/**
 * the object containing the individual payments group within a Payment object. for DW Allocation computation
 */
...
public class PaymentDetail {
    ...
    public void setBookingCurrency(Currency bookingCurrency) {
        this.bookingCurrency = bookingCurrency;
    }
    ...
    public void setRepricingTerm(String repricingTerm) {
        this.repricingTerm = repricingTerm;
    }

    public void setRepricingTermCode(String repricingTermCode) {
        this.repricingTermCode = repricingTermCode;
    }
    ...
    public void setThirdToUsdRateName(String thirdToUsdRateName) {
        this.thirdToUsdRateName = thirdToUsdRateName;
    }

    public void setThirdToPhpRateName(String thirdToPhpRateName) {
        this.thirdToPhpRateName = thirdToPhpRateName;
    }

    public void setUsdToPhpRateName(String usdToPhpRateName) {
        this.usdToPhpRateName = usdToPhpRateName;
    }

    public void setUrrRateName(String urrRateName) {
        this.urrRateName = urrRateName;
    }

    public void setThirdToUsdRateDescription(String thirdToUsdRateDescription) {
        this.thirdToUsdRateDescription = thirdToUsdRateDescription;
    }

    public void setThirdToPhpRateDescription(String thirdToPhpRateDescription) {
        this.thirdToPhpRateDescription = thirdToPhpRateDescription;
    }

    public void setUsdToPhpRateDescription(String usdToPhpRateDescription) {
        this.usdToPhpRateDescription = usdToPhpRateDescription;
    }

    public void setUrrRateDescription(String urrRateDescription) {
        this.urrRateDescription = urrRateDescription;
    }
