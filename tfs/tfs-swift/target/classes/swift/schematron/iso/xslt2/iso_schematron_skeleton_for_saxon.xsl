...
<!-- 
  ...
  XSLT 1:
     A schema using the standard XSLT 1 rest binding will have a /schema/@queryBinding='xslt' or
     nothing.
  ...
  EXSLT:  Experimental support
     A schema using the EXSLT rest binding will have a /schema/@queryBinding='exslt'.
  ...
  XSLT 2:   Experimental support
     A schema using the XSLT 2 rest binding will have a /schema/@queryBinding='xslt2'.
  ...
  XPATH:    Experimental support
     A schema using the XPATH rest binding will have a /schema/@queryBinding='xpath'.
     ...
     The intent of this rest binding is to support minimal non-XSLT implementations of
...
<!--
  VERSION INFORMATION
	...
	* Default rest language binding is "xslt" not "xslt1"
   ...
   Version:2006-11-07 (ISO: first release private to schematron-love-in maillist for review)
    ...
    KNOWN TYPICAL LIMITATIONS:
     ...
     EXTENSIONS:
      ISO Schematron is designed as a framework with some standard rest language
...
<!-- Uses unknown rest language binding -->
