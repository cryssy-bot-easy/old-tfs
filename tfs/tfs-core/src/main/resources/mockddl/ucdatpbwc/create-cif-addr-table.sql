...
CREATE TABLE @cif@.CFADDR (
  ...
  INSERT INTO @cif@.CFADDR ("CFCIF#",CFASEQ,CFNA2,CFNA3,CFNA4) VALUES ('1234567',1,'8017 TANGUELI ST.                       ','SAN ANOTONIO                            ','MAKATI CITY                             ');
INSERT INTO @cif@.CFADDR ("CFCIF#",CFASEQ,CFNA2,CFNA3,CFNA4) VALUES ('2345342',2,'8017 TANGUELI ST SAN ANOTIO             ','PEMBO                                   ','MAKATI CITY                             ');
INSERT INTO @cif@.CFADDR ("CFCIF#",CFASEQ,CFNA2,CFNA3,CFNA4) VALUES ('3234567',12,'8017 TANGUELI ST.                       ','SAN ANOTONIO                            ','MAKATI CITY                             ');
INSERT INTO @cif@.CFADDR ("CFCIF#",CFASEQ,CFNA2,CFNA3,CFNA4) VALUES ('9806767',13,'#21 LOWER BRGY. TO-ONG                  ','CEBU CITY                               ','                                        ');