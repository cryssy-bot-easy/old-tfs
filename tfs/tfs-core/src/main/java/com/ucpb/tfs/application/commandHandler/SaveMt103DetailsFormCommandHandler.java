...
public class SaveMt103DetailsFormCommandHandler implements CommandHandler<SaveMt103DetailsFormCommand> {
    ...
    @Override
    public void handle(SaveMt103DetailsFormCommand command) {
    ...
    private void printParameters(Map<String, Object> parameterMap) {
        System.out.println("inside save mt103 details form command handler...");
