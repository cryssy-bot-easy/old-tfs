...
public class SaveDetailsOfGuaranteeFormCommandHandler implements CommandHandler<SaveDetailsOfGuaranteeFormCommand> {
    ...
    @Override
	public void handle(SaveDetailsOfGuaranteeFormCommand command) {
	...
	private void printParameters(Map<String, Object> parameterMap) {
		System.out.println("inside save details of guarantee form command handler...");
