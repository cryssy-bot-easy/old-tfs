...
@Audited
public class DirectRemittance extends TradeProduct {
	...
	public DirectRemittance(){
		
	}
	
	public DirectRemittance(DocumentNumber documentNumber, Map<String, Object> details) {
		super(documentNumber, ProductType.DR);
		...
		this.dateOfBlAirwayBill = new Date((String)details.get("dateOfBlAirwayBill"));
	...
	public void updateDetails(Map<String, Object> details) {
        System.out.println("\nDirectRemittance.updatePaymentDetails() ===========\n");
...
//	public void settle(BigDecimal amount) {
	public void settle(Map<String, Object> details) {
		System.out.println("DR details: " + details);
