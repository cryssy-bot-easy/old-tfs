...
public class ServiceInstructionMarkedForReversalEvent implements DomainEvent{

    private ServiceInstructionId serviceInstructionId;
    private TradeServiceId tradeServiceId;

    public ServiceInstructionMarkedForReversalEvent(ServiceInstructionId serviceInstructionId, TradeServiceId tradeServiceId) {
