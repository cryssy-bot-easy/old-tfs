...
public class SaveMt202DetailsFormCommandHandler implements CommandHandler<SaveMt202DetailsFormCommand> {
    ...
    @Override
    public void handle(SaveMt202DetailsFormCommand command) {
    ...
    private void printParameters(Map<String, Object> parameterMap) {
        System.out.println("inside save mt202 details form command handler...");
