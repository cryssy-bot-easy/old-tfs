...
public class SavePddtsFormCommandHandler implements CommandHandler<SavePddtsFormCommand> {
    ...
    @Override
    public void handle(SavePddtsFormCommand command) {
    ...
    private void printParameters(Map<String, Object> parameterMap) {
        System.out.println("inside save pddts form command handler...");
