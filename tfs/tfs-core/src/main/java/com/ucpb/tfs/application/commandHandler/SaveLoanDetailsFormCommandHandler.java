...
public class SaveLoanDetailsFormCommandHandler implements CommandHandler<SaveLoanDetailsFormCommand> {
    ...
    @Override
    public void handle(SaveLoanDetailsFormCommand command) {
    ...
    private void printParameters(Map<String, Object> parameterMap) {
        System.out.println("inside save loan details form command handler...");
