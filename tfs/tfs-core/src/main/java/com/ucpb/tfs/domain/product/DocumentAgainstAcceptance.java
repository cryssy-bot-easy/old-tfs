...
@Audited
public class DocumentAgainstAcceptance extends TradeProduct {
	...
	public DocumentAgainstAcceptance(){
		
	}
	public DocumentAgainstAcceptance(DocumentNumber documentNumber, Map<String, Object> details) {
	...
	public void updateDetails(Map<String, Object> details) {
        System.out.println("\nDocumentAgainstAcceptance.updatePaymentDetails() ===========\n");
    ...
    public void updateStatus(TradeProductStatus tradeProductStatus) {
        ...
        switch(tradeProductStatus) {
            case ACKNOWLEDGED: case ACCEPTED:
                this.processDate = new Date();
            break;
        }
    }
	
	public void cancelDa() {
		this.cancelledDate = new Date();
		this.status = TradeProductStatus.CANCELLED;
	}
	
	public void accept(Map<String, Object> details){
		
		this.maturityDate = new Date((String)details.get("maturityDate"));
		
	}
	
//	public void settle(BigDecimal amount) {
	public void settle(Map<String, Object> details) {
		System.out.println("DA details: " + details);
