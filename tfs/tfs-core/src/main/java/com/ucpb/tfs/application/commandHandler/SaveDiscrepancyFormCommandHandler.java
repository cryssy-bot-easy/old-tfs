...
public class SaveDiscrepancyFormCommandHandler implements CommandHandler<SaveDiscrepancyFormCommand> {
    ...
    @Override
    public void handle(SaveDiscrepancyFormCommand command) {
    ...
    private void printParameters(Map<String, Object> parameterMap) {
        System.out.println("inside save discrepancy form command handler...");
