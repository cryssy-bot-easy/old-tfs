...
public class DPSettlementCreatedEvent implements DomainEvent {

	private TradeService tradeService;
    private DocumentAgainstPayment documentAgainstPayment;
    private String gltsNumber;

	public DPSettlementCreatedEvent(TradeService tradeService, DocumentAgainstPayment documentAgainstPayment, String gltsNumber) {
