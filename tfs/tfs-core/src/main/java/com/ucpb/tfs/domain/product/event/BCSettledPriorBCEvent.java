...
Member Type: Java
Project: CORE
Project Name: BCSettledPriorBCEvent.java
 */

public class BCSettledPriorBCEvent implements DomainEvent {

	private final TradeService tradeService;
	private final ExportBills exportBills;
    private String gltsNumber;
	
	public BCSettledPriorBCEvent(TradeService tradeService, ExportBills exportBills, String gltsNumber) {
