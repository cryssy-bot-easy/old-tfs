...
/**
 */
public class ARSettledEvent implements DomainEvent {

    private TradeService tradeService;
    private AccountsReceivable accountsReceivable;
    private String gltsNumber;

    public ARSettledEvent(TradeService tradeService, AccountsReceivable accountsReceivable, String gltsNumber) {
