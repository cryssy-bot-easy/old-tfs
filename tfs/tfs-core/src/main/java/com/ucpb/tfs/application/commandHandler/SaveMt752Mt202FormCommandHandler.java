...
public class SaveMt752Mt202FormCommandHandler implements CommandHandler<SaveMt752Mt202FormCommand> {
    ...
    @Override
    public void handle(SaveMt752Mt202FormCommand command) {
    ...
    private void printParameters(Map<String, Object> parameterMap) {
        System.out.println("inside save mt752 / 202 details command handler...");
