...
public class ReturnIncomingMtCommandHandler implements CommandHandler<ReturnIncomingMtCommand> {

    @Inject
    MtMessageRepository mtMessageRepository;

    @Override
    public void handle(ReturnIncomingMtCommand command) {
    ...
    private void printParameters(Map<String, Object> parameterMap) {
        System.out.println("inside return incoming mt command handler...");
