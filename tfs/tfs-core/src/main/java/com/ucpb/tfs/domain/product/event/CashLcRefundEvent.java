 ...
 * Date: 9/25/12
 */
public class CashLcRefundEvent implements DomainEvent {

    private TradeService tradeService;
    private LetterOfCredit letterOfCredit;
    private String gltsNumber;

    public CashLcRefundEvent(TradeService tradeService, LetterOfCredit letterOfCredit, String gltsNumber) {
