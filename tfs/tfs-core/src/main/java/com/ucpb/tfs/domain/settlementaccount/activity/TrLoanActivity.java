 ...
 * Date: 7/25/12
 */
public class TrLoanActivity extends Activity {
    ...
    public TrLoanActivity() {
        super();
        super.setSettlementAccountType(SettlementAccountType.TR_LOAN);
    }
     ...
     * @throws Exception
     */
    public TrLoanActivity(BigDecimal amount, Currency currency, ActivityType activityType, ReferenceType referenceType, String referenceNumber, String... otherDetails) throws Exception {

        super(amount, currency, activityType, referenceType, referenceNumber);

        // Use otherDetails for parameters specific to TrLoanActivity only.
