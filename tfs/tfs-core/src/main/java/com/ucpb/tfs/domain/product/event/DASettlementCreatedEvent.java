...
public class DASettlementCreatedEvent implements DomainEvent {

	private TradeService tradeService;
    private DocumentAgainstAcceptance documentAgainstAcceptance;
    private String gltsNumber;

	public DASettlementCreatedEvent(TradeService tradeService, DocumentAgainstAcceptance documentAgainstAcceptance, String gltsNumber) {
