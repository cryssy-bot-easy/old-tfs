 ...
 * Date: 9/25/12
 */
public class LetterOfCreditCreatedEvent implements DomainEvent {

    private TradeService tradeService;
    private LetterOfCredit letterOfCredit;
    private String gltsNumber;

    public LetterOfCreditCreatedEvent(TradeService tradeService, LetterOfCredit letterOfCredit, String gltsNumber) {
