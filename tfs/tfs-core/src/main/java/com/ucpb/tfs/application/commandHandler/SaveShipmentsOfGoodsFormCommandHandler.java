...
public class SaveShipmentsOfGoodsFormCommandHandler implements CommandHandler<SaveShipmentsOfGoodsFormCommand> {
    ...
    @Override
	public void handle(SaveShipmentsOfGoodsFormCommand command) {
	...
	private void printParameters(Map<String, Object> parameterMap) {
		System.out.println("inside shipments of goods form command handler...");
