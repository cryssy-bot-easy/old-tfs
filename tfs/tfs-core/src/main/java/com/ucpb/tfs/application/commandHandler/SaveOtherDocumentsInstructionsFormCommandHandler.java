...
public class SaveOtherDocumentsInstructionsFormCommandHandler implements CommandHandler<SaveOtherDocumentsInstructionsFormCommand> {
    ...
    @Override
	public void handle(SaveOtherDocumentsInstructionsFormCommand command) {
	...
	private void printParameters(Map<String, Object> parameterMap) {
		System.out.println("inside save other documents instructions form command handler...");
