...
public class SaveImporterExporterDetailsFormCommandHandler implements CommandHandler<SaveImporterExporterDetailsFormCommand>{
    ...
    @Override
	public void handle(SaveImporterExporterDetailsFormCommand command) {
	...
	private void printParameters(Map<String, Object> parameterMap) {
		System.out.println("inside save importer exporter details command handler...");
