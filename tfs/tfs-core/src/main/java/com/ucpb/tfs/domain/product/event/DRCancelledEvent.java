...
public class DRCancelledEvent implements DomainEvent {

	private TradeService tradeService;
    private DirectRemittance directRemittance;
    private String gltsNumber;

	public DRCancelledEvent(TradeService tradeService,DirectRemittance directRemittance, String gltsNumber) {
