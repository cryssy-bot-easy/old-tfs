...
public class SaveAdditionalDetailsFormCommandHandler implements CommandHandler<SaveAdditionalDetailsFormCommand> {
    ...
    @Override
	public void handle(SaveAdditionalDetailsFormCommand command) {
	...
	private void printParameters(Map<String, Object> parameterMap) {
		System.out.println("inside save additional details form command handler...");
