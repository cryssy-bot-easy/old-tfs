...
/**
 */
public class IndemnityCancelledEvent implements DomainEvent {
    ...
    public IndemnityCancelledEvent(TradeService tradeService, Indemnity indemnity, LetterOfCredit letterOfCredit, String gltsNumber) {
