 ...
 * Time: 00:23 AM
 */
class ExportBillsChargesTest {

    @Test
    public void testExportBillsCollectionSettlement() {
    ...
    //@Test
    public void testExportBillsCollectionCancellation() {
        CurrencyConverter currencyConverter = new CurrencyConverter()
        FXLCChargesCalculator calculator = new FXLCChargesCalculator();
    ...
    //@Test
    public void testExportBillsPaymentNegotiation() {
        CurrencyConverter currencyConverter = new CurrencyConverter()
        FXLCChargesCalculator calculator = new FXLCChargesCalculator();
